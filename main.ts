namespace SpriteKind {
    export const JEM = SpriteKind.create()
    export const COIN = SpriteKind.create()
    export const light = SpriteKind.create()
    export const cute = SpriteKind.create()
    export const sue = SpriteKind.create()
    export const coco = SpriteKind.create()
    export const StatusBar = SpriteKind.create()
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.sue, function (sprite, otherSprite) {
    tiles.setCurrentTilemap(tilemap`level6`)
    tiles.placeOnRandomTile(mySprite2, sprites.dungeon.darkGroundCenter)
    mySprite2.setKind(SpriteKind.coco)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.light, function (sprite, otherSprite) {
    ...
    mySprite2.setKind(SpriteKind.cute)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.coco, function (sprite, otherSprite) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.cute, function (sprite, otherSprite) {
    tiles.setCurrentTilemap(tilemap`level5`)
    tiles.placeOnRandomTile(mySprite2, assets.tile`myTile9`)
    mySprite2.setKind(SpriteKind.sue)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.COIN, function (sprite, otherSprite) {
    ...
    mySprite2.setKind(SpriteKind.light)
    tiles.placeOnRandomTile(mySprite, assets.tile`myTile4`)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.JEM, function (sprite, otherSprite) {
    tiles.setCurrentTilemap(tilemap`level2`)
    tiles.placeOnRandomTile(mySprite2, sprites.dungeon.darkGroundCenter)
    mySprite2.setKind(SpriteKind.COIN)
})
...
game.splash("you got", "2 minutes to win this game")
...
forever(function () {
    music.play(music.createSong(hex`0078000408020106001c00010a006400f4016400000400000000000000000000000000000000024d0000000400020a1e04000800012c08000c0001160c001000012510001400010d14001800011e1c00200002112c20002400012428002c00020f222c0030000129300034000308161d340038000124`), music.PlaybackMode.UntilDone)
    music.play(music.createSong(hex`0078000408020106001c00010a006400f4016400000400000000000000000000000000000000023e0008000c00020d240c00100002122c140018000212251c002000020d1e20002400012528002c00020a242c003000012c3000340001243400380004080f1e2a`), music.PlaybackMode.UntilDone)
})
forever(function () {
    timer.after(120500, function () {
        info.changeLifeBy(-1)
    })
})
